...
<div class="col-md-6 hero-tagline my-auto">
  <h1>NewJeans</h1>
<p><span class="fw-bold">Newjeans </span>adalah sebuah girl group Korea Selatan yang dibentuk oleh <i>ADOR</i>, sebuah label musik yang berkolaborasi dengan HYBE. Grup ini terdiri dari lima anggota: <b>Minji, Hanni, Danielle, Haerin, dan Hyein</b>. Mereka debut pada tahun 2022 dengan lagu “Attention”, yang menjadi nomor satu di Circle Digital Chart Korea Selatan. Mereka juga merilis album mini pertama mereka, New Jeans, pada bulan Agustus 2022 </p>
...
<a href="#">
  <img src="img/eva_arrow-ios-forward-fill.png">
    ...
    <img src="{{asset('assets/asset/img/WhatsApp Image 2023-07-26 at 08.43 1.png')}}" class="position-absolute end-0 bottom-0 img-hero">
  </div>
</section>
